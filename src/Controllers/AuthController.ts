...
if(process.env.JWT_SECRET) var jwt_secret: string | Buffer<ArrayBufferLike> | GetPublicKeyOrSecret = process.env.JWT_SECRET;

export const protectRoutes = handleAsyncErr( async (req: Request, res: Response, next: NextFunction) => {
    let token;
